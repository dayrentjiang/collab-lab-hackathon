          ...
          <div className="flex justify-between mb-8">
            <div
              className={`flex flex-col items-center ${
                currentStep === "basics" ? "text-blue-500" : "text-gray-500"
              }`}
            >
              <div
            ...
            <div className="flex-1 flex items-center">
              <div
                className={`flex-grow h-0.5 ${
                  currentStep !== "basics" ? "bg-blue-500" : "bg-gray-200"
                }`}
              ></div>
            </div>
            <div
              className={`flex flex-col items-center ${
                currentStep === "skills" ? "text-blue-500" : "text-gray-500"
              }`}
            >
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${
            ...
            <div className="flex-1 flex items-center">
              <div
                className={`flex-grow h-0.5 ${
                  currentStep === "education" || currentStep === "review"
                    ? "bg-blue-500"
                    : "bg-gray-200"
                }`}
              ></div>
            ...
            <div
              className={`flex flex-col items-center ${
                currentStep === "education" ? "text-blue-500" : "text-gray-500"
              }`}
            >
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${
            ...
            <div
              className={`flex flex-col items-center ${
                currentStep === "review" ? "text-blue-500" : "text-gray-500"
              }`}
            >
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${
                ...
                <AddSkill
                  ...
                  error={
                    formData.selected_skills.length === 0
                      ? "Please select at least one skill to help match you with relevant projects."
                      : null
                  }
                />
              </div>
              ...
              <div className="space-y-4 bg-gray-50 p-4 rounded-md">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    {formData.user_bio || "Not provided"}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    {formData.user_university || "Not provided"}
                  </p>
                </div>
