...
export default function ApplyToProjectPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Create application
      await createApplication(projectId, user.id, applicationMsg);
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 border-b border-gray-100">
          ...
          <p className="text-gray-600">
            Tell the project creator why you're interested and what skills you
        ...
        <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="flex flex-wrap gap-2">
              <div className="text-sm">
                ...
                <span className="text-gray-600">
                  {projectData.project_vacancy} team members
                </span>
              </div>
          ...
          <div className="mb-6">
            <label
              htmlFor="application_msg"
              className="block text-sm font-medium text-gray-700 mb-1"
            >
              Your Application <span className="text-red-500">*</span>
            </label>
            <p className="text-sm text-gray-500 mb-2">
              Explain why you're interested in this project, what skills and
              experience you bring, and how you can contribute to its success.
            </p>
            <textarea
              id="application_msg"
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button
              ...
              className={`px-6 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                isSubmitting || applicationMsg.length < 50
